...
namespace RefactoringEssentials
{
	...
	static partial class SyntaxNodeExtensions
    {
        ...
        public static (SyntaxToken, SyntaxToken) GetBraces(this SyntaxNode node)
        {
            ...
            return (default(SyntaxToken), default(SyntaxToken));
        }

        public static (SyntaxToken, SyntaxToken) GetParentheses(this SyntaxNode node)
        {
            return node.TypeSwitch(
                ...
                (ForEachStatementSyntax n) => (n.OpenParenToken, n.CloseParenToken),
                ...
                (SyntaxNode n) => (default(SyntaxToken), default(SyntaxToken)));
        }

        public static (SyntaxToken, SyntaxToken) GetBrackets(this SyntaxNode node)
        {
            return node.TypeSwitch(
